...
worldItems = {
    'Welcome Sign': {
        ...
        LONGDESC: 'The welcome sign reads, "Welcome to this city. You can type "help" for a list of commands to use. Be sure to check out Al\'s cool programming books at http://inventwithpython.com"',
        TAKEABLE: False,
    ...
    'README Note': {
        ...
        LONGDESC: 'The README note reads, "Welcome to the city. Be sure to check out the source code to see how this game is put together."',
        EDIBLE: True,
